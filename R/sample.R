...
#' @export
#'
#' @examples Sample(data1,data2,100)#data1 is a data.frame of expression profile which the samples are case-sample,data2 is also a data.frame of expression profile which the samples are control-sample
Sample<-function(datacase,datacontrol,count){
